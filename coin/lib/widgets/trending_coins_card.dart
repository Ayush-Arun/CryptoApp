...
class TrendingCoinsCard extends StatelessWidget {
  const TrendingCoinsCard({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<CryptoProvider>(
      builder: (context, provider, child) {
        final trendingCoins = provider.trendingCryptocurrencies;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ...trendingCoins.take(5).map((coin) => _buildTrendingCoinRow(context, coin)),
              ],
            ),
          ),
        );
  ...
  Widget _buildTrendingCoinRow(BuildContext context, CryptoCoin coin) {
    return Padding(
        ...
        lineBarsData: [
          LineChartBarData(
            ...
            belowBarData: BarAreaData(
              show: true,
              color: (coin.isPositive ? Colors.green : Colors.red).withValues(alpha: 0.1),
            ),
          ),
        ],
      ),
